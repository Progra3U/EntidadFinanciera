<%@ Page Title="" Language="C#" MasterPageFile="~/SitioWeb/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Administradores.aspx.cs" Inherits="_01Presentacion.SitioWeb.Administradores" %>
...
<body id="body">
	<div class="sidebar">
		...
		<ul>
            ...
            <li><a href="SubPages/Administradores/A_Servicios.aspx" target="_blank" onclick="window.open(this.href, this.target, 'width=960,height=800,top=50,left=500'); return false;">servicios</a></li>
