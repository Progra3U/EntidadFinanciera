    ...
    <div id="wrap">
        ...
        <section id="FormUsuarios">
            <form>
                ...
                <asp:TextBox class="textBox" size="30" type="email" ID="TextBox1" pattern="^[_a-z0-9-]+(.[_a-z0-9-]+)*@[a-z0-9-]+(.[a-z0-9-]+)*(.[a-z]{2,4})$" placeholder="email@server.doamin" required runat="server"></asp:TextBox> 
