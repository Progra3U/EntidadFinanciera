<%@ Page Title="" Language="C#" MasterPageFile="~/SitioWeb/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="_01Presentacion.SitioWeb.Index" %>
    ...
    <section id="main">
      ...
      <section id="contenido">
            ...
            <div class="tradingview-widget-container">
              ...
              new TradingView.widget(
                  {"width": 700,"height": 500,"symbol": "NASDAQ:AAPL","interval": "D","timezone": "America/El_Salvador",
      ...
      <aside>
        <section class="widget">
          ...
          <ul>
              <li>
                  <a href="https://pt.fx-exchange.com/usd/crc.html" target="_blank">Dólar Americano(USD) Para Costa Rica(CRC)</a>
              </li>   
              <li>
                  <!-- Inicio widget Dolar-Colombia.com -->
                  <script id="dollar" src="https://www.dolar-colombia.com/widget.js"></script>
                  <!-- Fin widget Dolar-Colombia.com -->
              </li> 
